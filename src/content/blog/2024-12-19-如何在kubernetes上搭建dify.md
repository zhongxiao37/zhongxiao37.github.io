...
本文是基于[Winson-030 的代码](https://github.com/Winson-030/dify-kubernetes/tree/feature/pvc-volume)部署的。
...
我们的阿里云 ACK 是 Serverless 的，默认是没有安装 CoreDNS。需要安装 CoreDNS，否则没法通过 Service 访问 Pod.

## Demo

由于之前自己已经通过 Bert 部署了意图识别和意图处理两个微服务，我需要的就是调用这两个微服务，然后拼起来。
